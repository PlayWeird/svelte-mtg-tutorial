    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(button0, "click", /*plusClick*/ ctx[5]),
    					listen(button1, "click", /*minusClick*/ ctx[6])
    				];
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", "svelte-nxf88j");
    			attr(button, "class", "svelte-nxf88j");
    			attr(main, "class", "svelte-nxf88j");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*newGame*/ ctx[5]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
